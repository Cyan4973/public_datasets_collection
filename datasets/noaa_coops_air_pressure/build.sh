...
dataset_id = "noaa_coops_air_pressure"; series_id = "air_pressure_f64"; series_dir = samples_root / series_id; index_path = index_root / "samples.jsonl"; stats_path = filtered_root / "station_stats.tsv"
stations = [
...
def parse_station(station):
 ...
 raw_file_count = raw_row_count = duplicate_rows = skipped_rows = 0
