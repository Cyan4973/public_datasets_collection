...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/nasa_power_daily_solar_wind"
FILTERED_ROOT="${DATA_DIR}/filtered/nasa_power_daily_solar_wind"
INDEX_ROOT="${DATA_DIR}/index/nasa_power_daily_solar_wind"
SAMPLES_ROOT="${DATA_DIR}/samples/nasa_power_daily_solar_wind"
LOG_ROOT="${DATA_DIR}/logs/nasa_power_daily_solar_wind"
...
dataset_id = "nasa_power_daily_solar_wind"
locations = ["san_francisco", "phoenix", "chicago", "miami", "anchorage"]
parameter_ids = ["ALLSKY_SFC_SW_DWN", "WS2M", "WS10M"]
series_defs = [
