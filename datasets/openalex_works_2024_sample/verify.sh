...
EXPECTED_PRIMARY = {
    ...
    "openalex_fwci",
    "openalex_citation_normalized_percentile",
    "openalex_primary_topic_score",
    "openalex_has_fulltext",
    "openalex_is_retracted",
    "openalex_citation_top_1_percent",
    "openalex_citation_top_10_percent",
    "openalex_cited_by_percentile_year_min",
    "openalex_indexed_in_count",
    "openalex_awards_count",
    "openalex_funders_count",
    "openalex_counts_by_year_count",
    "openalex_related_works_count",
}
...
def unpack_values(path: Path, numeric_kind: str, bit_width: int, count: int) -> tuple[int | float, ...]:
    code_by_type = {
        ("uint", 8): "B",
        ("uint", 16): "H",
        ("uint", 32): "I",
