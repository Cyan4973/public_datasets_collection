...
parameter_series = {
    "ALLSKY_SFC_SW_DWN": {"series_id": "nasa_power_solar_allsky_sw_down_f64", "array_type": "d", "numeric_kind": "float", "bit_width": 64, "endianness": "little", "element_size_bytes": 8},
    "CLRSKY_SFC_SW_DWN": {"series_id": "nasa_power_solar_clrsky_sw_down_f64", "array_type": "d", "numeric_kind": "float", "bit_width": 64, "endianness": "little", "element_size_bytes": 8},
    "TOA_SW_DWN": {"series_id": "nasa_power_solar_toa_sw_down_f64", "array_type": "d", "numeric_kind": "float", "bit_width": 64, "endianness": "little", "element_size_bytes": 8},
}
