...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/owid_energy_per_capita_annual"
FILTERED_ROOT="${DATA_DIR}/filtered/owid_energy_per_capita_annual"
INDEX_ROOT="${DATA_DIR}/index/owid_energy_per_capita_annual"
SAMPLES_ROOT="${DATA_DIR}/samples/owid_energy_per_capita_annual"
LOG_ROOT="${DATA_DIR}/logs/owid_energy_per_capita_annual"
...
dataset_id = "owid_energy_per_capita_annual"
