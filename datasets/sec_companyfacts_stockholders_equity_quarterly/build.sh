...
series_defs = [
    {"series_id": "stockholders_equity_i64", "array_type": "q", "numeric_kind": "int", "bit_width": 64, "endianness": "little", "element_size_bytes": 8},
...
with stats_path.open("w", encoding="utf-8", newline="") as stats_file:
    ...
    for company_id, cik in companies:
        ...
        payloads = {
            "stockholders_equity_i64": values,
            "obs_year_u16": years,
