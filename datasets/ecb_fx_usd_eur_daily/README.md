...
Selected scope:
- ECB series key: `D.USD.EUR.SP00.A`
...
```sh
bash datasets/ecb_fx_usd_eur_daily/download.sh
bash datasets/ecb_fx_usd_eur_daily/build.sh
bash datasets/ecb_fx_usd_eur_daily/verify.sh
```
