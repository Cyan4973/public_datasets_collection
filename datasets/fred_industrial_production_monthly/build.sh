...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/fred_industrial_production_monthly"
FILTERED_ROOT="${DATA_DIR}/filtered/fred_industrial_production_monthly"
INDEX_ROOT="${DATA_DIR}/index/fred_industrial_production_monthly"
SAMPLES_ROOT="${DATA_DIR}/samples/fred_industrial_production_monthly"
LOG_ROOT="${DATA_DIR}/logs/fred_industrial_production_monthly"
...
dataset_id = "fred_industrial_production_monthly"
fred_series_id = "INDPRO"
value_column = "INDPRO"
series_defs = [
    {"series_id": "industrial_production_f32", "array_type": "f", "numeric_kind": "float", "bit_width": 32, "endianness": "little", "element_size_bytes": 4},
...
path = download_root / "fred_industrial_production_monthly.csv"
if not path.is_file():
...
for year in sorted(year_values):
    payloads = {
        "industrial_production_f32": year_values[year],
