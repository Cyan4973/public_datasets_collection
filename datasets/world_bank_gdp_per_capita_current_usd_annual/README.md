...
- `gdp_per_capita_current_usd_f64` (`float64`, little-endian)
...
```sh
bash datasets/world_bank_gdp_per_capita_current_usd_annual/download.sh
bash datasets/world_bank_gdp_per_capita_current_usd_annual/build.sh
bash datasets/world_bank_gdp_per_capita_current_usd_annual/verify.sh
```
