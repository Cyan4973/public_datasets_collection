...
This staging recipe collects recent DWD RADOLAN RW radar precipitation composites and emits one raw little-endian `uint16` sample per composite.
...
staging/dwd_radolan_rw_precip_i16/build.sh
staging/dwd_radolan_rw_precip_i16/verify.sh
```
