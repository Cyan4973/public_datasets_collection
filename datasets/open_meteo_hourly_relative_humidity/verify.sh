...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/open_meteo_hourly_relative_humidity"
FILTERED_ROOT="${DATA_DIR}/filtered/open_meteo_hourly_relative_humidity"
INDEX_ROOT="${DATA_DIR}/index/open_meteo_hourly_relative_humidity"
SAMPLES_ROOT="${DATA_DIR}/samples/open_meteo_hourly_relative_humidity"
LOG_ROOT="${DATA_DIR}/logs/open_meteo_hourly_relative_humidity"
...
dataset_id = "open_meteo_hourly_relative_humidity"
parameter_id = "relative_humidity_2m"
