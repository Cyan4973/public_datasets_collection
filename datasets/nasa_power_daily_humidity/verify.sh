...
START_YEAR=${NASA_POWER_DAILY_HUMIDITY_START_YEAR:-1981}
END_YEAR=${NASA_POWER_DAILY_HUMIDITY_END_YEAR:-2024}
MIN_VALUES_PER_SAMPLE=${NASA_POWER_DAILY_HUMIDITY_MIN_VALUES_PER_SAMPLE:-15000}
...
parameter_series = {
    "RH2M": {"series_id": "nasa_power_humidity_rh2m_f64", "numeric_kind": "float", "bit_width": 64, "endianness": "little", "element_size_bytes": 8},
    "T2MDEW": {"series_id": "nasa_power_humidity_t2mdew_f64", "numeric_kind": "float", "bit_width": 64, "endianness": "little", "element_size_bytes": 8},
}
