...
- `fertility_rate_f64` (`float64`, little-endian)
...
```sh
bash datasets/world_bank_fertility_rate_annual/download.sh
bash datasets/world_bank_fertility_rate_annual/build.sh
bash datasets/world_bank_fertility_rate_annual/verify.sh
```
