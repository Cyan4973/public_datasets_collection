...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/open_meteo_hourly_apparent_temperature"
FILTERED_ROOT="${DATA_DIR}/filtered/open_meteo_hourly_apparent_temperature"
INDEX_ROOT="${DATA_DIR}/index/open_meteo_hourly_apparent_temperature"
SAMPLES_ROOT="${DATA_DIR}/samples/open_meteo_hourly_apparent_temperature"
LOG_ROOT="${DATA_DIR}/logs/open_meteo_hourly_apparent_temperature"
...
dataset_id = "open_meteo_hourly_apparent_temperature"
parameter_id = "apparent_temperature"
