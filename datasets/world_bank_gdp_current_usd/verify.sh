...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/world_bank_gdp_current_usd"
FILTERED_ROOT="${DATA_DIR}/filtered/world_bank_gdp_current_usd"
INDEX_ROOT="${DATA_DIR}/index/world_bank_gdp_current_usd"
SAMPLES_ROOT="${DATA_DIR}/samples/world_bank_gdp_current_usd"
LOG_ROOT="${DATA_DIR}/logs/world_bank_gdp_current_usd"
...
dataset_id = "world_bank_gdp_current_usd"
indicator_id = "NY.GDP.MKTP.CD"
countries = ["USA", "CHN", "IND", "BRA", "DEU", "JPN", "NGA", "MEX", "FRA", "ZAF"]
series_defs = [
    {"series_id": "world_bank_value_f64", "numeric_kind": "float", "bit_width": 64, "endianness": "little", "element_size_bytes": 8},
]
