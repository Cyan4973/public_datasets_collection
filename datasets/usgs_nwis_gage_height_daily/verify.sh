...
MIN_SAMPLE_COUNT=${USGS_NWIS_GAGE_HEIGHT_MIN_SAMPLE_COUNT:-20}
MIN_TOTAL_VALUES=${USGS_NWIS_GAGE_HEIGHT_MIN_TOTAL_VALUES:-150000}
...
for record in records:
    ...
    if series_id != "usgs_gage_height_ft_f64":
...
print(
    f"verified {sample_count} gage-height samples, {total_values} values, "
