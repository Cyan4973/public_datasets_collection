# ECB FX RON/EUR Daily

This recipe collects the ECB daily RON/EUR exchange-rate series and emits one
sample per year.

Selected scope:
- ECB series key: `D.RON.EUR.SP00.A`
...
```sh
bash datasets/ecb_fx_ron_eur_daily/download.sh
bash datasets/ecb_fx_ron_eur_daily/build.sh
bash datasets/ecb_fx_ron_eur_daily/verify.sh
```
