...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/open_meteo_hourly_precipitation"
FILTERED_ROOT="${DATA_DIR}/filtered/open_meteo_hourly_precipitation"
INDEX_ROOT="${DATA_DIR}/index/open_meteo_hourly_precipitation"
SAMPLES_ROOT="${DATA_DIR}/samples/open_meteo_hourly_precipitation"
LOG_ROOT="${DATA_DIR}/logs/open_meteo_hourly_precipitation"
...
dataset_id = "open_meteo_hourly_precipitation"
