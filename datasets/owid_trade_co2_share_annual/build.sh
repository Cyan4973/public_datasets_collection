...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/owid_trade_co2_share_annual"
FILTERED_ROOT="${DATA_DIR}/filtered/owid_trade_co2_share_annual"
INDEX_ROOT="${DATA_DIR}/index/owid_trade_co2_share_annual"
SAMPLES_ROOT="${DATA_DIR}/samples/owid_trade_co2_share_annual"
LOG_ROOT="${DATA_DIR}/logs/owid_trade_co2_share_annual"
...
dataset_id = "owid_trade_co2_share_annual"
target_column = "trade_co2_share"
