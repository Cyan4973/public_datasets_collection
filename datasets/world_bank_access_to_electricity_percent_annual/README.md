...
```sh
bash datasets/world_bank_access_to_electricity_percent_annual/download.sh
bash datasets/world_bank_access_to_electricity_percent_annual/build.sh
bash datasets/world_bank_access_to_electricity_percent_annual/verify.sh
```
