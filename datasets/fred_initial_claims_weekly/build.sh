...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/fred_initial_claims_weekly"
FILTERED_ROOT="${DATA_DIR}/filtered/fred_initial_claims_weekly"
INDEX_ROOT="${DATA_DIR}/index/fred_initial_claims_weekly"
SAMPLES_ROOT="${DATA_DIR}/samples/fred_initial_claims_weekly"
LOG_ROOT="${DATA_DIR}/logs/fred_initial_claims_weekly"
...
dataset_id = "fred_initial_claims_weekly"
fred_series_id = "ICSA"
value_column = "ICSA"
series_defs = [
    {"series_id": "initial_claims_f32", "array_type": "f", "numeric_kind": "float", "bit_width": 32, "endianness": "little", "element_size_bytes": 4},
...
path = download_root / "fred_initial_claims_weekly.csv"
if not path.is_file():
...
for year in sorted(year_values):
    payloads = {
        "initial_claims_f32": year_values[year],
