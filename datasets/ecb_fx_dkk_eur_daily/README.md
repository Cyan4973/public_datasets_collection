# ECB FX DKK/EUR Daily

This recipe collects the ECB daily DKK/EUR exchange-rate series and emits one
sample per year.

Selected scope:
- ECB series key: `D.DKK.EUR.SP00.A`
...
```sh
bash datasets/ecb_fx_dkk_eur_daily/download.sh
bash datasets/ecb_fx_dkk_eur_daily/build.sh
bash datasets/ecb_fx_dkk_eur_daily/verify.sh
```
