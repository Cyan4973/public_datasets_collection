...
- Candidate dataset: BLS CPI monthly, series `CUUR0000SA0`
- Source:
  - `https://api.bls.gov/publicAPI/v2/timeseries/data/`
- Why it looked promising:
  - public labor-statistics API
  - monthly macroeconomic numeric series
...
- What happened:
  ...
  - No raw JSON payload was written to `.data/downloads/bls_cpi_monthly/`.
...
- Evidence:
  - no `.data/downloads/bls_cpi_monthly/bls_cpi_monthly.json`
  - build failure: missing raw JSON
- Logs:
  - `.data/logs/bls_cpi_monthly/download.latest.log`
  - `.data/logs/bls_cpi_monthly/build.latest.log`
  - `.data/logs/bls_cpi_monthly/verify.latest.log`
- Decision:
