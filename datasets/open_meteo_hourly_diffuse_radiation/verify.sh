...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/open_meteo_hourly_diffuse_radiation"
FILTERED_ROOT="${DATA_DIR}/filtered/open_meteo_hourly_diffuse_radiation"
INDEX_ROOT="${DATA_DIR}/index/open_meteo_hourly_diffuse_radiation"
SAMPLES_ROOT="${DATA_DIR}/samples/open_meteo_hourly_diffuse_radiation"
LOG_ROOT="${DATA_DIR}/logs/open_meteo_hourly_diffuse_radiation"
...
dataset_id = "open_meteo_hourly_diffuse_radiation"
parameter_id = "diffuse_radiation"
