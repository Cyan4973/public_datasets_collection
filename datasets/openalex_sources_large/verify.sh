...
EXPECTED_PRIMARY = {
    ...
    "openalex_source_cited_by_count_u32",
    "openalex_source_2yr_mean_citedness_f32",
    "openalex_source_h_index_u16",
    "openalex_source_i10_index_u32",
    "openalex_source_first_publication_year_u16",
    "openalex_source_last_publication_year_u16",
    "openalex_source_topic_count_u8",
}
