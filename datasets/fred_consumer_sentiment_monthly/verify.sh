...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/fred_consumer_sentiment_monthly"
FILTERED_ROOT="${DATA_DIR}/filtered/fred_consumer_sentiment_monthly"
INDEX_ROOT="${DATA_DIR}/index/fred_consumer_sentiment_monthly"
SAMPLES_ROOT="${DATA_DIR}/samples/fred_consumer_sentiment_monthly"
LOG_ROOT="${DATA_DIR}/logs/fred_consumer_sentiment_monthly"
...
dataset_id = "fred_consumer_sentiment_monthly"
fred_series_id = "UMCSENT"
value_column = "UMCSENT"
series_defs = [
...
path = download_root / "fred_consumer_sentiment_monthly.csv"
if not path.is_file():
