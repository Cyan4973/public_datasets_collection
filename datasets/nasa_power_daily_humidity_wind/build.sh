...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/nasa_power_daily_humidity_wind"
FILTERED_ROOT="${DATA_DIR}/filtered/nasa_power_daily_humidity_wind"
INDEX_ROOT="${DATA_DIR}/index/nasa_power_daily_humidity_wind"
SAMPLES_ROOT="${DATA_DIR}/samples/nasa_power_daily_humidity_wind"
LOG_ROOT="${DATA_DIR}/logs/nasa_power_daily_humidity_wind"
...
dataset_id = "nasa_power_daily_humidity_wind"
locations = ["san_francisco", "phoenix", "chicago", "miami", "anchorage"]
parameter_ids = ["RH2M", "WS2M", "WS50M"]
series_defs = [
