...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/fred_ppi_all_commodities_monthly"
FILTERED_ROOT="${DATA_DIR}/filtered/fred_ppi_all_commodities_monthly"
INDEX_ROOT="${DATA_DIR}/index/fred_ppi_all_commodities_monthly"
SAMPLES_ROOT="${DATA_DIR}/samples/fred_ppi_all_commodities_monthly"
LOG_ROOT="${DATA_DIR}/logs/fred_ppi_all_commodities_monthly"
...
dataset_id = "fred_ppi_all_commodities_monthly"
fred_series_id = "PPIACO"
value_column = "PPIACO"
series_defs = [
    {"series_id": "ppi_all_commodities_f32", "array_type": "f", "numeric_kind": "float", "bit_width": 32, "endianness": "little", "element_size_bytes": 4},
...
path = download_root / "fred_ppi_all_commodities_monthly.csv"
if not path.is_file():
...
for year in sorted(year_values):
    payloads = {
        "ppi_all_commodities_f32": year_values[year],
