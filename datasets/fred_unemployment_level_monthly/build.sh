...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/fred_unemployment_level_monthly"
FILTERED_ROOT="${DATA_DIR}/filtered/fred_unemployment_level_monthly"
INDEX_ROOT="${DATA_DIR}/index/fred_unemployment_level_monthly"
SAMPLES_ROOT="${DATA_DIR}/samples/fred_unemployment_level_monthly"
LOG_ROOT="${DATA_DIR}/logs/fred_unemployment_level_monthly"
...
dataset_id = "fred_unemployment_level_monthly"
fred_series_id = "UNEMPLOY"
value_column = "UNEMPLOY"
series_defs = [
    {"series_id": "unemployment_level_f32", "array_type": "f", "numeric_kind": "float", "bit_width": 32, "endianness": "little", "element_size_bytes": 4},
...
path = download_root / "fred_unemployment_level_monthly.csv"
if not path.is_file():
...
for year in sorted(year_values):
    payloads = {
        "unemployment_level_f32": year_values[year],
