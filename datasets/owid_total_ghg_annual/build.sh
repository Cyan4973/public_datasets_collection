...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/owid_total_ghg_annual"
FILTERED_ROOT="${DATA_DIR}/filtered/owid_total_ghg_annual"
INDEX_ROOT="${DATA_DIR}/index/owid_total_ghg_annual"
SAMPLES_ROOT="${DATA_DIR}/samples/owid_total_ghg_annual"
LOG_ROOT="${DATA_DIR}/logs/owid_total_ghg_annual"
...
dataset_id = "owid_total_ghg_annual"
