...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/open_meteo_hourly_temperature"
FILTERED_ROOT="${DATA_DIR}/filtered/open_meteo_hourly_temperature"
INDEX_ROOT="${DATA_DIR}/index/open_meteo_hourly_temperature"
SAMPLES_ROOT="${DATA_DIR}/samples/open_meteo_hourly_temperature"
LOG_ROOT="${DATA_DIR}/logs/open_meteo_hourly_temperature"
...
dataset_id = "open_meteo_hourly_temperature"
parameter_id = "temperature_2m"
