...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/open_meteo_hourly_dew_point"
FILTERED_ROOT="${DATA_DIR}/filtered/open_meteo_hourly_dew_point"
INDEX_ROOT="${DATA_DIR}/index/open_meteo_hourly_dew_point"
SAMPLES_ROOT="${DATA_DIR}/samples/open_meteo_hourly_dew_point"
LOG_ROOT="${DATA_DIR}/logs/open_meteo_hourly_dew_point"
...
dataset_id = "open_meteo_hourly_dew_point"
parameter_id = "dew_point_2m"
