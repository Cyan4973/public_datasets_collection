...
dataset_id = "noaa_coops_water_temperature"; series_id = "water_temperature_f64"; series_dir = samples_root / series_id; index_path = index_root / "samples.jsonl"; stats_path = filtered_root / "station_stats.tsv"; failures_path = download_root / "download_failures.tsv"
stations = [
