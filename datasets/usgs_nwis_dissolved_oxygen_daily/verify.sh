...
site_ids = ["07374000"]
series_defs = [
 {"series_id":"usgs_dissolved_oxygen_f64","numeric_kind":"float","bit_width":64,"endianness":"little","element_size_bytes":8},
