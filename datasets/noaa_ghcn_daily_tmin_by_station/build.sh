...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/noaa_ghcn_daily_tmin_by_station"
FILTERED_ROOT="${DATA_DIR}/filtered/noaa_ghcn_daily_tmin_by_station"
INDEX_ROOT="${DATA_DIR}/index/noaa_ghcn_daily_tmin_by_station"
SAMPLES_ROOT="${DATA_DIR}/samples/noaa_ghcn_daily_tmin_by_station"
LOG_ROOT="${DATA_DIR}/logs/noaa_ghcn_daily_tmin_by_station"
