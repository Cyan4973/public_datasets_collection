...
```sh
bash datasets/world_bank_population_total/download.sh
bash datasets/world_bank_population_total/build.sh
bash datasets/world_bank_population_total/verify.sh
```
