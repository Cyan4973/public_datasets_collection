...
```sh
bash datasets/world_bank_gdp_current_usd/download.sh
bash datasets/world_bank_gdp_current_usd/build.sh
bash datasets/world_bank_gdp_current_usd/verify.sh
```
