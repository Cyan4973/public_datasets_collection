...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/open_meteo_hourly_pressure_msl"
FILTERED_ROOT="${DATA_DIR}/filtered/open_meteo_hourly_pressure_msl"
INDEX_ROOT="${DATA_DIR}/index/open_meteo_hourly_pressure_msl"
SAMPLES_ROOT="${DATA_DIR}/samples/open_meteo_hourly_pressure_msl"
LOG_ROOT="${DATA_DIR}/logs/open_meteo_hourly_pressure_msl"
...
dataset_id = "open_meteo_hourly_pressure_msl"
parameter_id = "pressure_msl"
