...
MIN_ROWS_KEPT = 300_000
EXPECTED_PRIMARY = {
    "openalex_author_works_count_u32",
    "openalex_author_cited_by_count_u32",
    "openalex_author_h_index_u16",
    "openalex_author_i10_index_u32",
    "openalex_author_raw_name_count_u8",
    "openalex_author_affiliation_count_u16",
    "openalex_author_topic_count_u8",
}
