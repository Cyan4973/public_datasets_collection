...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/usgs_nwis_dissolved_oxygen_daily"
FILTERED_ROOT="${DATA_DIR}/filtered/usgs_nwis_dissolved_oxygen_daily"
INDEX_ROOT="${DATA_DIR}/index/usgs_nwis_dissolved_oxygen_daily"
SAMPLES_ROOT="${DATA_DIR}/samples/usgs_nwis_dissolved_oxygen_daily"
LOG_ROOT="${DATA_DIR}/logs/usgs_nwis_dissolved_oxygen_daily"
...
with stats_path.open("w", encoding="utf-8", newline="") as stats_file:
 ...
 for site_id in site_ids:
  ...
  payloads = {"usgs_dissolved_oxygen_f64": value_series, "obs_year_u16": year_values, "obs_month_u8": month_values, "obs_day_u8": day_values}
  for series in series_defs:
