# CDC COVID New Deaths State Daily
...
- intended output: one signed daily `new_death` sample per state plus aligned date arrays

## What Was Tried

- queried `https://data.cdc.gov/resource/9mfq-cb36.csv`
- fixed five-state subset: `CA`, `TX`, `FL`, `NY`, `IL`
- selected columns: `submission_date`, `state`, `new_death`
...
- download log: `.data/logs/cdc_covid_new_deaths_state_daily/download.latest.log`
- build log: `.data/logs/cdc_covid_new_deaths_state_daily/build.latest.log`
