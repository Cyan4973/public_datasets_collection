...
expected = {
    'openml_run_id_u32': ('uint', 32, 4, '<I'),
    'openml_task_id_u32': ('uint', 32, 4, '<I'),
    'openml_setup_id_u32': ('uint', 32, 4, '<I'),
    'openml_flow_id_u32': ('uint', 32, 4, '<I'),
    'openml_uploader_u32': ('uint', 32, 4, '<I'),
    'openml_upload_timestamp_u64': ('uint', 64, 8, '<Q'),
}
