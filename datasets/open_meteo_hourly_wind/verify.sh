...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/open_meteo_hourly_wind"
FILTERED_ROOT="${DATA_DIR}/filtered/open_meteo_hourly_wind"
INDEX_ROOT="${DATA_DIR}/index/open_meteo_hourly_wind"
SAMPLES_ROOT="${DATA_DIR}/samples/open_meteo_hourly_wind"
LOG_ROOT="${DATA_DIR}/logs/open_meteo_hourly_wind"
...
dataset_id = "open_meteo_hourly_wind"
parameter_id = "wind_speed_10m"
