...
START_YEAR=${NASA_POWER_DAILY_SOLAR_FLUX_START_YEAR:-1984}
END_YEAR=${NASA_POWER_DAILY_SOLAR_FLUX_END_YEAR:-2024}
MIN_VALUES_PER_SAMPLE=${NASA_POWER_DAILY_SOLAR_FLUX_MIN_VALUES_PER_SAMPLE:-14900}
...
parameter_series = {
    "ALLSKY_SFC_SW_DWN": {"series_id": "nasa_power_solar_allsky_sw_down_f64", "numeric_kind": "float", "bit_width": 64, "endianness": "little", "element_size_bytes": 8},
    "CLRSKY_SFC_SW_DWN": {"series_id": "nasa_power_solar_clrsky_sw_down_f64", "numeric_kind": "float", "bit_width": 64, "endianness": "little", "element_size_bytes": 8},
    "TOA_SW_DWN": {"series_id": "nasa_power_solar_toa_sw_down_f64", "numeric_kind": "float", "bit_width": 64, "endianness": "little", "element_size_bytes": 8},
}
