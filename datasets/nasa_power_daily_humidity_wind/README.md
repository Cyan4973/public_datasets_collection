# NASA POWER Daily_Humidity_Wind
...
```sh
bash datasets/nasa_power_daily_humidity_wind/download.sh
bash datasets/nasa_power_daily_humidity_wind/build.sh
bash datasets/nasa_power_daily_humidity_wind/verify.sh
```
