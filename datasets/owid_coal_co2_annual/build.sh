...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/owid_coal_co2_annual"
FILTERED_ROOT="${DATA_DIR}/filtered/owid_coal_co2_annual"
INDEX_ROOT="${DATA_DIR}/index/owid_coal_co2_annual"
SAMPLES_ROOT="${DATA_DIR}/samples/owid_coal_co2_annual"
LOG_ROOT="${DATA_DIR}/logs/owid_coal_co2_annual"
...
dataset_id = "owid_coal_co2_annual"
target_column = "coal_co2"
