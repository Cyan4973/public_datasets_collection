...
```sh
bash datasets/nasa_power_daily_temp_precip_humidity/download.sh
bash datasets/nasa_power_daily_temp_precip_humidity/build.sh
bash datasets/nasa_power_daily_temp_precip_humidity/verify.sh
```
