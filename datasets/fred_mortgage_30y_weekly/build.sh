...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/fred_mortgage_30y_weekly"
FILTERED_ROOT="${DATA_DIR}/filtered/fred_mortgage_30y_weekly"
INDEX_ROOT="${DATA_DIR}/index/fred_mortgage_30y_weekly"
SAMPLES_ROOT="${DATA_DIR}/samples/fred_mortgage_30y_weekly"
LOG_ROOT="${DATA_DIR}/logs/fred_mortgage_30y_weekly"
...
dataset_id = "fred_mortgage_30y_weekly"
fred_series_id = "MORTGAGE30US"
value_column = "MORTGAGE30US"
series_defs = [
    {"series_id": "mortgage_30y_f32", "array_type": "f", "numeric_kind": "float", "bit_width": 32, "endianness": "little", "element_size_bytes": 4},
]
...
path = download_root / "fred_mortgage_30y_weekly.csv"
if not path.is_file():
...
for year in sorted(year_values):
    payloads = {
        "mortgage_30y_f32": year_values[year],
    }
    for series in series_defs:
