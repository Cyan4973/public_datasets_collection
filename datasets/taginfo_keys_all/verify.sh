...
expected = {
    "taginfo_count_all": ("uint", 64, 8, "<Q"),
    "taginfo_count_nodes": ("uint", 64, 8, "<Q"),
    "taginfo_count_ways": ("uint", 64, 8, "<Q"),
    "taginfo_count_relations": ("uint", 64, 8, "<Q"),
    "taginfo_values_all": ("uint", 64, 8, "<Q"),
    "taginfo_users_all": ("uint", 64, 8, "<Q"),
    "taginfo_in_wiki": ("uint", 8, 1, "<B"),
    "taginfo_projects": ("uint", 16, 2, "<H"),
}
...
for row in primary:
    ...
    if row.get("sample_geometry") != "taginfo_key_table_column" or int(row.get("sample_rank", 0)) != 1:
