...
OUT="$DOWNLOAD_DIR/taginfo_tags_popular.json"
URL="https://taginfo.openstreetmap.org/api/4/tags/popular?page=1&rp=500"
...
assert isinstance(obj,dict) and isinstance(obj.get('data'),list) and len(obj['data'])>0
PY2
mv "$TMP" "$OUT"
