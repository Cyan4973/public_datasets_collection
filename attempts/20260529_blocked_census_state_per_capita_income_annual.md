# census_state_per_capita_income_annual

- Date: 2026-05-29
- Status: blocked
- Candidate dataset: U.S. Census annual state per capita income
- Source:
...
- Logs:
  - `.data/logs/census_state_per_capita_income_annual/download.latest.log`
- Decision:
