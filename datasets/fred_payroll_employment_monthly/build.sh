...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/fred_payroll_employment_monthly"
FILTERED_ROOT="${DATA_DIR}/filtered/fred_payroll_employment_monthly"
INDEX_ROOT="${DATA_DIR}/index/fred_payroll_employment_monthly"
SAMPLES_ROOT="${DATA_DIR}/samples/fred_payroll_employment_monthly"
LOG_ROOT="${DATA_DIR}/logs/fred_payroll_employment_monthly"
...
dataset_id = "fred_payroll_employment_monthly"
fred_series_id = "PAYEMS"
value_column = "PAYEMS"
series_defs = [
    {"series_id": "payroll_employment_f32", "array_type": "f", "numeric_kind": "float", "bit_width": 32, "endianness": "little", "element_size_bytes": 4},
...
path = download_root / "fred_payroll_employment_monthly.csv"
if not path.is_file():
...
for year in sorted(year_values):
    payloads = {
        "payroll_employment_f32": year_values[year],
