...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/fred_federal_funds_monthly"
FILTERED_ROOT="${DATA_DIR}/filtered/fred_federal_funds_monthly"
INDEX_ROOT="${DATA_DIR}/index/fred_federal_funds_monthly"
SAMPLES_ROOT="${DATA_DIR}/samples/fred_federal_funds_monthly"
LOG_ROOT="${DATA_DIR}/logs/fred_federal_funds_monthly"
...
dataset_id = "fred_federal_funds_monthly"
...
path = download_root / "fred_federal_funds_monthly.csv"
if not path.is_file():
