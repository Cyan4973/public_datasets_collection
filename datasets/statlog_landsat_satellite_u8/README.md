...
land-cover *class* labels (`esa_worldcover_landcover_tiles_u8`), and decoded
weather-radar radials (`noaa_nexrad_level3_nids_radials_u8`), but no
**optical satellite reflectance**. The DN values here are the sensor's *native*
