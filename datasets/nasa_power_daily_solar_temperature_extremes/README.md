# NASA POWER Daily_Solar_Temperature_Extremes
...
```sh
bash datasets/nasa_power_daily_solar_temperature_extremes/download.sh
bash datasets/nasa_power_daily_solar_temperature_extremes/build.sh
bash datasets/nasa_power_daily_solar_temperature_extremes/verify.sh
```
