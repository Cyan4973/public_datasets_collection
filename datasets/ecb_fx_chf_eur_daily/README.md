# ECB FX CHF/EUR Daily

This recipe collects the ECB daily CHF/EUR exchange-rate series and emits one
sample per year.

Selected scope:
- ECB series key: `D.CHF.EUR.SP00.A`
...
```sh
bash datasets/ecb_fx_chf_eur_daily/download.sh
bash datasets/ecb_fx_chf_eur_daily/build.sh
bash datasets/ecb_fx_chf_eur_daily/verify.sh
```
