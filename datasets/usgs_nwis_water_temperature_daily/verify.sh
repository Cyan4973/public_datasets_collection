...
MIN_TOTAL_VALUES="${USGS_NWIS_WATER_TEMPERATURE_MIN_TOTAL_VALUES:-350000}"
MAX_PRIMARY_BYTES="${USGS_NWIS_WATER_TEMPERATURE_MAX_PRIMARY_BYTES:-1000000000}"
...
total_bytes = 0
for row in rows:
    if row.get("series_id") != "usgs_water_temperature_c_f64":
