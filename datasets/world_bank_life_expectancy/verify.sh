...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/world_bank_life_expectancy"
FILTERED_ROOT="${DATA_DIR}/filtered/world_bank_life_expectancy"
INDEX_ROOT="${DATA_DIR}/index/world_bank_life_expectancy"
SAMPLES_ROOT="${DATA_DIR}/samples/world_bank_life_expectancy"
LOG_ROOT="${DATA_DIR}/logs/world_bank_life_expectancy"
