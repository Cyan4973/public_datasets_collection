# stooq_daily_equities

- Date: 2026-05-29
- Status: rejected
- Candidate dataset: Stooq daily equities
- Source:
  - `https://stooq.com/q/d/l/`
- Why it looked promising:
  - public market-history CSV endpoint
  - daily numeric price series across multiple symbols
...
- Logs:
  - `.data/logs/stooq_daily_equities/download.latest.log`
  - `.data/logs/stooq_daily_equities/build.latest.log`
  - `.data/logs/stooq_daily_equities/verify.latest.log`
- Decision:
