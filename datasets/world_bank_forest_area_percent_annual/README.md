...
- `forest_area_percent_f64` (`float64`, little-endian)
...
```sh
bash datasets/world_bank_forest_area_percent_annual/download.sh
bash datasets/world_bank_forest_area_percent_annual/build.sh
bash datasets/world_bank_forest_area_percent_annual/verify.sh
```
