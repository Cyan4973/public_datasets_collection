...
series_defs = [
    {"series_id": "industrial_production_index_f32", "array_type": "f", "numeric_kind": "float", "bit_width": 32, "endianness": "little", "element_size_bytes": 4},
...
with stats_path.open("w", encoding="utf-8", newline="") as stats_file:
    ...
    for country_code in countries:
        ...
        payloads = {
            "industrial_production_index_f32": values,
            "obs_year_u16": years,
        }
        for series in series_defs:
