...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/fred_wti_crude_daily"
FILTERED_ROOT="${DATA_DIR}/filtered/fred_wti_crude_daily"
INDEX_ROOT="${DATA_DIR}/index/fred_wti_crude_daily"
SAMPLES_ROOT="${DATA_DIR}/samples/fred_wti_crude_daily"
LOG_ROOT="${DATA_DIR}/logs/fred_wti_crude_daily"
...
dataset_id = "fred_wti_crude_daily"
fred_series_id = "DCOILWTICO"
value_column = "DCOILWTICO"
series_defs = [
    {"series_id": "wti_crude_f32", "array_type": "f", "numeric_kind": "float", "bit_width": 32, "endianness": "little", "element_size_bytes": 4},
...
path = download_root / "fred_wti_crude_daily.csv"
if not path.is_file():
...
for year in sorted(year_values):
    payloads = {
        "wti_crude_f32": year_values[year],
