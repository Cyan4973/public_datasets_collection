...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/owid_energy_per_gdp_annual"
FILTERED_ROOT="${DATA_DIR}/filtered/owid_energy_per_gdp_annual"
INDEX_ROOT="${DATA_DIR}/index/owid_energy_per_gdp_annual"
SAMPLES_ROOT="${DATA_DIR}/samples/owid_energy_per_gdp_annual"
LOG_ROOT="${DATA_DIR}/logs/owid_energy_per_gdp_annual"
...
dataset_id = "owid_energy_per_gdp_annual"
target_column = "energy_per_gdp"
