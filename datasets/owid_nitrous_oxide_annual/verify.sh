...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/owid_nitrous_oxide_annual"
FILTERED_ROOT="${DATA_DIR}/filtered/owid_nitrous_oxide_annual"
INDEX_ROOT="${DATA_DIR}/index/owid_nitrous_oxide_annual"
SAMPLES_ROOT="${DATA_DIR}/samples/owid_nitrous_oxide_annual"
LOG_ROOT="${DATA_DIR}/logs/owid_nitrous_oxide_annual"
...
dataset_id = "owid_nitrous_oxide_annual"
target_column = "nitrous_oxide"
