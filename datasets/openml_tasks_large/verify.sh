...
expected = {
    'openml_task_id_u32': ('uint', 32, 4, '<I'),
    'openml_dataset_id_u32': ('uint', 32, 4, '<I'),
    'openml_task_type_id_u16': ('uint', 16, 2, '<H'),
    'openml_number_of_instances_f32': ('float', 32, 4, '<f'),
    'openml_number_of_features_f32': ('float', 32, 4, '<f'),
    'openml_number_of_classes_f32': ('float', 32, 4, '<f'),
    'openml_number_of_missing_values_f32': ('float', 32, 4, '<f'),
    'openml_number_of_instances_with_missing_values_f32': ('float', 32, 4, '<f'),
    'openml_number_of_numeric_features_f32': ('float', 32, 4, '<f'),
    'openml_number_of_symbolic_features_f32': ('float', 32, 4, '<f'),
}
...
if statistics.median(row['value_count'] for row in rows) < 10000:
