...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/fred_treasury_2y_daily"
FILTERED_ROOT="${DATA_DIR}/filtered/fred_treasury_2y_daily"
INDEX_ROOT="${DATA_DIR}/index/fred_treasury_2y_daily"
SAMPLES_ROOT="${DATA_DIR}/samples/fred_treasury_2y_daily"
LOG_ROOT="${DATA_DIR}/logs/fred_treasury_2y_daily"
...
path = download_root / "fred_treasury_2y_daily.csv"
if not path.is_file():
