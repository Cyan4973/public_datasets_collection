...
plan_path = Path(sys.argv[1]); base_url = "https://waterservices.usgs.gov/nwis/dv/"; sites = ["01646500","07374000","09380000"]
with plan_path.open("w", encoding="utf-8", newline="") as plan_file:
 for site in sites:
  for year in range(2021, 2024):
   params = {"format":"json","sites":site,"parameterCd":"00010","siteStatus":"all","startDT":f"{year}-01-01","endDT":f"{year}-12-31"}
