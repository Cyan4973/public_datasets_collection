...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/owid_co2_per_capita_annual"
FILTERED_ROOT="${DATA_DIR}/filtered/owid_co2_per_capita_annual"
INDEX_ROOT="${DATA_DIR}/index/owid_co2_per_capita_annual"
SAMPLES_ROOT="${DATA_DIR}/samples/owid_co2_per_capita_annual"
LOG_ROOT="${DATA_DIR}/logs/owid_co2_per_capita_annual"
...
dataset_id = "owid_co2_per_capita_annual"
