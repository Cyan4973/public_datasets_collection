...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/fred_labor_force_participation_monthly"
FILTERED_ROOT="${DATA_DIR}/filtered/fred_labor_force_participation_monthly"
INDEX_ROOT="${DATA_DIR}/index/fred_labor_force_participation_monthly"
SAMPLES_ROOT="${DATA_DIR}/samples/fred_labor_force_participation_monthly"
LOG_ROOT="${DATA_DIR}/logs/fred_labor_force_participation_monthly"
...
dataset_id = "fred_labor_force_participation_monthly"
fred_series_id = "CIVPART"
value_column = "CIVPART"
series_defs = [
...
path = download_root / "fred_labor_force_participation_monthly.csv"
if not path.is_file():
