# Census ACS 1-Year State Median Household Income Annual
...
- intended output: one annual state median household income sample per state plus aligned year arrays

## What Was Tried

- queried yearly ACS 1-year endpoints for `2015..2023`
- fixed variable: `B19013_001E`
- no API key provided
...
- download log: `.data/logs/census_acs1_state_median_household_income_annual/download.latest.log`
- build log: `.data/logs/census_acs1_state_median_household_income_annual/build.latest.log`
