...
- `internet_users_percent_f64` (`float64`, little-endian)
...
```sh
bash datasets/world_bank_internet_users_percent_annual/download.sh
bash datasets/world_bank_internet_users_percent_annual/build.sh
bash datasets/world_bank_internet_users_percent_annual/verify.sh
```
