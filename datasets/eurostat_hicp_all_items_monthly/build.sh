...
DATASET_ID="eurostat_hicp_all_items_monthly"
...
series_defs = [
    {"series_id": "hicp_all_items_index_f32", "array_type": "f", "numeric_kind": "float", "bit_width": 32, "endianness": "little", "element_size_bytes": 4},
]
...
with stats_path.open("w", encoding="utf-8", newline="") as stats_file:
    ...
    for country_code in countries:
        ...
        payloads = {
            "hicp_all_items_index_f32": values,
        }
        for series in series_defs:
