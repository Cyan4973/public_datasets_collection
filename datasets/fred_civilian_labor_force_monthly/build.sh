...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/fred_civilian_labor_force_monthly"
FILTERED_ROOT="${DATA_DIR}/filtered/fred_civilian_labor_force_monthly"
INDEX_ROOT="${DATA_DIR}/index/fred_civilian_labor_force_monthly"
SAMPLES_ROOT="${DATA_DIR}/samples/fred_civilian_labor_force_monthly"
LOG_ROOT="${DATA_DIR}/logs/fred_civilian_labor_force_monthly"
...
dataset_id = "fred_civilian_labor_force_monthly"
fred_series_id = "CLF16OV"
value_column = "CLF16OV"
series_defs = [
...
path = download_root / "fred_civilian_labor_force_monthly.csv"
if not path.is_file():
