# Census ACS 1-Year State Per Capita Income Annual
...
- intended output: one annual state per-capita-income sample per state plus aligned year arrays

## What Was Tried

- queried yearly ACS 1-year endpoints for `2015..2023`
- fixed variable: `B19301_001E`
- no API key provided
...
- download log: `.data/logs/census_acs1_state_per_capita_income_annual/download.latest.log`
- build log: `.data/logs/census_acs1_state_per_capita_income_annual/build.latest.log`
