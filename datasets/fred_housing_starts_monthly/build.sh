...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/fred_housing_starts_monthly"
FILTERED_ROOT="${DATA_DIR}/filtered/fred_housing_starts_monthly"
INDEX_ROOT="${DATA_DIR}/index/fred_housing_starts_monthly"
SAMPLES_ROOT="${DATA_DIR}/samples/fred_housing_starts_monthly"
LOG_ROOT="${DATA_DIR}/logs/fred_housing_starts_monthly"
...
dataset_id = "fred_housing_starts_monthly"
fred_series_id = "HOUST"
value_column = "HOUST"
series_defs = [
    {"series_id": "housing_starts_f32", "array_type": "f", "numeric_kind": "float", "bit_width": 32, "endianness": "little", "element_size_bytes": 4},
...
path = download_root / "fred_housing_starts_monthly.csv"
if not path.is_file():
...
for year in sorted(year_values):
    payloads = {
        "housing_starts_f32": year_values[year],
