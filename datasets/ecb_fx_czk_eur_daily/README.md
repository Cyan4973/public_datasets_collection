...
Selected scope:
- ECB series key: `D.CZK.EUR.SP00.A`
...
```sh
bash datasets/ecb_fx_czk_eur_daily/download.sh
bash datasets/ecb_fx_czk_eur_daily/build.sh
bash datasets/ecb_fx_czk_eur_daily/verify.sh
```
