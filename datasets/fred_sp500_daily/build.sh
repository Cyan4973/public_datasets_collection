...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/fred_sp500_daily"
FILTERED_ROOT="${DATA_DIR}/filtered/fred_sp500_daily"
INDEX_ROOT="${DATA_DIR}/index/fred_sp500_daily"
SAMPLES_ROOT="${DATA_DIR}/samples/fred_sp500_daily"
LOG_ROOT="${DATA_DIR}/logs/fred_sp500_daily"
...
path = download_root / "fred_sp500_daily.csv"
if not path.is_file():
