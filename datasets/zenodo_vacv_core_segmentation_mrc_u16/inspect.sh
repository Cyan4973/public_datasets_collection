...
RECIPE_DIR="$REPO_ROOT/datasets/zenodo_vacv_core_segmentation_mrc_u16"
...
python3 "$RECIPE_DIR/scripts/inspect_mrc_u16.py" \
  --mrc "$DOWNLOAD_DIR/032_original_ground_truth.mrc" \
