# Census ACS 1-Year State Housing Units Annual
...
- intended output: one annual state housing-units sample per state plus aligned year arrays

## What Was Tried

- queried yearly ACS 1-year endpoints for `2015..2023`
- fixed variable: `B25001_001E`
- no API key provided
...
- download log: `.data/logs/census_acs1_state_housing_units_annual/download.latest.log`
- build log: `.data/logs/census_acs1_state_housing_units_annual/build.latest.log`
