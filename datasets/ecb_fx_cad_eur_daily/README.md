# ECB FX CAD/EUR Daily

This recipe collects the ECB daily CAD/EUR exchange-rate series and emits one
sample per year.

Selected scope:
- ECB series key: `D.CAD.EUR.SP00.A`
...
```sh
bash datasets/ecb_fx_cad_eur_daily/download.sh
bash datasets/ecb_fx_cad_eur_daily/build.sh
bash datasets/ecb_fx_cad_eur_daily/verify.sh
```
