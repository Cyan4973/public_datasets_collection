# Eurostat Male Male Unemployment Monthly
...
```sh
bash datasets/eurostat_male_unemployment_monthly/download.sh
bash datasets/eurostat_male_unemployment_monthly/build.sh
bash datasets/eurostat_male_unemployment_monthly/verify.sh
```

Logs are written under `${DATA_DIR:-.data}/logs/eurostat_male_unemployment_monthly/`.
