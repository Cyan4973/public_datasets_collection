...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/owid_renewables_share_energy_annual"
FILTERED_ROOT="${DATA_DIR}/filtered/owid_renewables_share_energy_annual"
INDEX_ROOT="${DATA_DIR}/index/owid_renewables_share_energy_annual"
SAMPLES_ROOT="${DATA_DIR}/samples/owid_renewables_share_energy_annual"
LOG_ROOT="${DATA_DIR}/logs/owid_renewables_share_energy_annual"
...
dataset_id = "owid_renewables_share_energy_annual"
target_column = "renewables_share_energy"
countries = ["USA", "CHN", "IND", "BRA", "DEU", "JPN", "NGA", "MEX", "FRA", "ZAF"]
series_defs = [
    {"series_id": "renewables_share_energy_f32", "array_type": "f", "numeric_kind": "float", "bit_width": 32, "endianness": "little", "element_size_bytes": 4},
...
with stats_path.open("w", encoding="utf-8", newline="") as stats_file:
    ...
    for country_code in countries:
        ...
        payloads = {"renewables_share_energy_f32": values, "obs_year_u16": years}
