...
```sh
bash datasets/owid_temperature_change_from_co2_annual/download.sh
bash datasets/owid_temperature_change_from_co2_annual/build.sh
bash datasets/owid_temperature_change_from_co2_annual/verify.sh
```
