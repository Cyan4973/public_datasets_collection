...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/fred_m2_money_stock_monthly"
FILTERED_ROOT="${DATA_DIR}/filtered/fred_m2_money_stock_monthly"
INDEX_ROOT="${DATA_DIR}/index/fred_m2_money_stock_monthly"
SAMPLES_ROOT="${DATA_DIR}/samples/fred_m2_money_stock_monthly"
LOG_ROOT="${DATA_DIR}/logs/fred_m2_money_stock_monthly"
...
path = download_root / "fred_m2_money_stock_monthly.csv"
if not path.is_file():
