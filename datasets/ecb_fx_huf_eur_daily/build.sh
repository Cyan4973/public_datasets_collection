...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/ecb_fx_huf_eur_daily"
FILTERED_ROOT="${DATA_DIR}/filtered/ecb_fx_huf_eur_daily"
INDEX_ROOT="${DATA_DIR}/index/ecb_fx_huf_eur_daily"
SAMPLES_ROOT="${DATA_DIR}/samples/ecb_fx_huf_eur_daily"
LOG_ROOT="${DATA_DIR}/logs/ecb_fx_huf_eur_daily"
...
dataset_id = "ecb_fx_huf_eur_daily"
series_key = "HUF.EUR"
series_defs = [
...
path = download_root / "huf_eur.csv"
if not path.is_file():
