...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/fred_fed_balance_sheet_weekly"
FILTERED_ROOT="${DATA_DIR}/filtered/fred_fed_balance_sheet_weekly"
INDEX_ROOT="${DATA_DIR}/index/fred_fed_balance_sheet_weekly"
SAMPLES_ROOT="${DATA_DIR}/samples/fred_fed_balance_sheet_weekly"
LOG_ROOT="${DATA_DIR}/logs/fred_fed_balance_sheet_weekly"
...
dataset_id = "fred_fed_balance_sheet_weekly"
...
path = download_root / "fred_fed_balance_sheet_weekly.csv"
if not path.is_file():
