...
DATASET_ID="imf_gdp_growth_annual"
...
indicator_id = "NGDP_RPCH"
countries = ["USA", "CHN", "IND", "BRA", "DEU", "JPN", "MEX", "ZAF"]
series_defs = [
    {"series_id": "gdp_growth_f32", "array_type": "f", "numeric_kind": "float", "bit_width": 32, "endianness": "little", "element_size_bytes": 4},
...
with stats_path.open("w", encoding="utf-8", newline="") as stats_file:
    ...
    for country_code in countries:
        ...
        payloads = {"gdp_growth_f32": values, "obs_year_u16": years}
        for series in series_defs:
