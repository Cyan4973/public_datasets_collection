...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/fred_real_gdp_quarterly"
FILTERED_ROOT="${DATA_DIR}/filtered/fred_real_gdp_quarterly"
INDEX_ROOT="${DATA_DIR}/index/fred_real_gdp_quarterly"
SAMPLES_ROOT="${DATA_DIR}/samples/fred_real_gdp_quarterly"
LOG_ROOT="${DATA_DIR}/logs/fred_real_gdp_quarterly"
...
dataset_id = "fred_real_gdp_quarterly"
fred_series_id = "GDPC1"
value_column = "GDPC1"
series_defs = [
    {"series_id": "real_gdp_f32", "array_type": "f", "numeric_kind": "float", "bit_width": 32, "endianness": "little", "element_size_bytes": 4},
]
...
path = download_root / "fred_real_gdp_quarterly.csv"
if not path.is_file():
