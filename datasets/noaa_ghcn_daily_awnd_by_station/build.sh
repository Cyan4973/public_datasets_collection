...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/noaa_ghcn_daily_awnd_by_station"
FILTERED_ROOT="${DATA_DIR}/filtered/noaa_ghcn_daily_awnd_by_station"
INDEX_ROOT="${DATA_DIR}/index/noaa_ghcn_daily_awnd_by_station"
SAMPLES_ROOT="${DATA_DIR}/samples/noaa_ghcn_daily_awnd_by_station"
LOG_ROOT="${DATA_DIR}/logs/noaa_ghcn_daily_awnd_by_station"
...
dataset_id = "noaa_ghcn_daily_awnd_by_station"
element_id = "AWND"
station_ids = [
    "USC00011084",
    "USC00024849",
