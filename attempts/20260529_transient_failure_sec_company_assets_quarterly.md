# sec_company_assets_quarterly

- Date: 2026-05-29
- Status: transient_failure
- Candidate dataset: SEC company assets quarterly
- Source:
...
- What happened:
  ...
  - No raw company JSON payloads were written under `.data/downloads/sec_company_assets_quarterly/`.
...
- Logs:
  - `.data/logs/sec_company_assets_quarterly/download.latest.log`
- Decision:
