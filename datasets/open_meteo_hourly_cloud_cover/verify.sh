...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/open_meteo_hourly_cloud_cover"
FILTERED_ROOT="${DATA_DIR}/filtered/open_meteo_hourly_cloud_cover"
INDEX_ROOT="${DATA_DIR}/index/open_meteo_hourly_cloud_cover"
SAMPLES_ROOT="${DATA_DIR}/samples/open_meteo_hourly_cloud_cover"
LOG_ROOT="${DATA_DIR}/logs/open_meteo_hourly_cloud_cover"
...
dataset_id = "open_meteo_hourly_cloud_cover"
parameter_id = "cloud_cover"
