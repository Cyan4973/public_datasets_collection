...
ALLOWED = {
    "anilist_average_score_u8",
    "anilist_popularity_u32",
    "anilist_favourites_u32",
    "anilist_episodes_u16",
    "anilist_duration_u16",
}
...
def unpack(path: Path, numeric_kind: str, bit_width: int, count: int) -> tuple:
    code = {("uint", 8): "B", ("uint", 16): "H", ("uint", 32): "I"}[(numeric_kind, bit_width)]
