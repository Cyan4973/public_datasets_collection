# ECB FX KRW/EUR Daily

This recipe collects the ECB daily KRW/EUR exchange-rate series and emits one
sample per year.

Selected scope:
- ECB series key: `D.KRW.EUR.SP00.A`
...
```sh
bash datasets/ecb_fx_krw_eur_daily/download.sh
bash datasets/ecb_fx_krw_eur_daily/build.sh
bash datasets/ecb_fx_krw_eur_daily/verify.sh
```
