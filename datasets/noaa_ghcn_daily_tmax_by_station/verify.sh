...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/noaa_ghcn_daily_tmax_by_station"
FILTERED_ROOT="${DATA_DIR}/filtered/noaa_ghcn_daily_tmax_by_station"
INDEX_ROOT="${DATA_DIR}/index/noaa_ghcn_daily_tmax_by_station"
SAMPLES_ROOT="${DATA_DIR}/samples/noaa_ghcn_daily_tmax_by_station"
LOG_ROOT="${DATA_DIR}/logs/noaa_ghcn_daily_tmax_by_station"
...
for station_id in station_ids:
    ...
    for series in series_defs:
        ...
        expected_records[(series["series_id"], station_id)] = {
            "dataset_id": "noaa_ghcn_daily_tmax_by_station",
