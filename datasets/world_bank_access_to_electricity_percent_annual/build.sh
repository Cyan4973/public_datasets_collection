...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/world_bank_access_to_electricity_percent_annual"
FILTERED_ROOT="${DATA_DIR}/filtered/world_bank_access_to_electricity_percent_annual"
INDEX_ROOT="${DATA_DIR}/index/world_bank_access_to_electricity_percent_annual"
SAMPLES_ROOT="${DATA_DIR}/samples/world_bank_access_to_electricity_percent_annual"
LOG_ROOT="${DATA_DIR}/logs/world_bank_access_to_electricity_percent_annual"
...
dataset_id = "world_bank_access_to_electricity_percent_annual"
