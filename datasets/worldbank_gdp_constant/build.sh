...
DATASET_ID="worldbank_gdp_constant"
...
rows_in = json.load(open(download_dir / "worldbank_gdp_constant.json", encoding="utf-8"))[1]
meta = {
...
(filter_dir / "ingest_stats.json").write_text(
    json.dumps({"dataset_id": "worldbank_gdp_constant", "rows_total": rows_total, "rows_skipped": rows_skipped}, indent=2, sort_keys=True) + "\n",
    encoding="utf-8",
)
