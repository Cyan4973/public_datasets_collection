...
MIN_VALUES_PER_SAMPLE=${NASA_POWER_DAILY_WIND_MIN_VALUES_PER_SAMPLE:-10000}
...
parameter_series = {
    "WS2M": {"series_id": "nasa_power_wind_ws2m_f64", "numeric_kind": "float", "bit_width": 64, "endianness": "little", "element_size_bytes": 8},
    "WS10M": {"series_id": "nasa_power_wind_ws10m_f64", "numeric_kind": "float", "bit_width": 64, "endianness": "little", "element_size_bytes": 8},
    "WS50M": {"series_id": "nasa_power_wind_ws50m_f64", "numeric_kind": "float", "bit_width": 64, "endianness": "little", "element_size_bytes": 8},
}
