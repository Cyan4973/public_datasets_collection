# ECB FX TRY/EUR Daily

This recipe collects the ECB daily TRY/EUR exchange-rate series and emits one
sample per year.

Selected scope:
- ECB series key: `D.TRY.EUR.SP00.A`
...
```sh
bash datasets/ecb_fx_try_eur_daily/download.sh
bash datasets/ecb_fx_try_eur_daily/build.sh
bash datasets/ecb_fx_try_eur_daily/verify.sh
```
