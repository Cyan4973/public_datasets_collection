# ECB FX GBP/EUR Daily

This recipe collects the ECB daily GBP/EUR exchange-rate series and emits one
sample per year.

Selected scope:
- ECB series key: `D.GBP.EUR.SP00.A`
...
```sh
bash datasets/ecb_fx_gbp_eur_daily/download.sh
bash datasets/ecb_fx_gbp_eur_daily/build.sh
bash datasets/ecb_fx_gbp_eur_daily/verify.sh
```
