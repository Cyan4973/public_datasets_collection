...
MIN_VALUES_PER_SAMPLE=${NASA_POWER_DAILY_TEMPERATURE_EXTREMES_MIN_VALUES_PER_SAMPLE:-15000}
...
parameter_series = {
    "T2M": {"series_id": "nasa_power_temperature_t2m_f64", "numeric_kind": "float", "bit_width": 64, "endianness": "little", "element_size_bytes": 8},
    "T2M_MAX": {"series_id": "nasa_power_temperature_t2m_max_f64", "numeric_kind": "float", "bit_width": 64, "endianness": "little", "element_size_bytes": 8},
    "T2M_MIN": {"series_id": "nasa_power_temperature_t2m_min_f64", "numeric_kind": "float", "bit_width": 64, "endianness": "little", "element_size_bytes": 8},
}
