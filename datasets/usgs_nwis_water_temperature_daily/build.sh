...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/usgs_nwis_water_temperature_daily"
FILTERED_ROOT="${DATA_DIR}/filtered/usgs_nwis_water_temperature_daily"
INDEX_ROOT="${DATA_DIR}/index/usgs_nwis_water_temperature_daily"
SAMPLES_ROOT="${DATA_DIR}/samples/usgs_nwis_water_temperature_daily"
LOG_ROOT="${DATA_DIR}/logs/usgs_nwis_water_temperature_daily"
...
dataset_id = "usgs_nwis_water_temperature_daily"
site_ids = ["01646500","07374000","09380000"]
series_defs = [
 {"series_id":"usgs_water_temperature_c_f64","array_type":"d","numeric_kind":"float","bit_width":64,"endianness":"little","element_size_bytes":8},
...
with stats_path.open("w", encoding="utf-8", newline="") as stats_file:
 ...
 for site_id in site_ids:
  value_series = []; year_values = []; month_values = []; day_values = []
  ...
  payloads = {"usgs_water_temperature_c_f64": value_series, "obs_year_u16": year_values, "obs_month_u8": month_values, "obs_day_u8": day_values}
  for series in series_defs:
