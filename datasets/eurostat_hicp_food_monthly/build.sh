...
DATASET_ID="eurostat_hicp_food_monthly"
...
series_defs = [
    {"series_id": "hicp_food_index_f32", "array_type": "f", "numeric_kind": "float", "bit_width": 32, "endianness": "little", "element_size_bytes": 4},
