...
Selected scope:
- ECB series key: `D.HUF.EUR.SP00.A`
...
```sh
bash datasets/ecb_fx_huf_eur_daily/download.sh
bash datasets/ecb_fx_huf_eur_daily/build.sh
bash datasets/ecb_fx_huf_eur_daily/verify.sh
```
