...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/owid_methane_annual"
FILTERED_ROOT="${DATA_DIR}/filtered/owid_methane_annual"
INDEX_ROOT="${DATA_DIR}/index/owid_methane_annual"
SAMPLES_ROOT="${DATA_DIR}/samples/owid_methane_annual"
LOG_ROOT="${DATA_DIR}/logs/owid_methane_annual"
...
dataset_id = "owid_methane_annual"
target_column = "methane"
