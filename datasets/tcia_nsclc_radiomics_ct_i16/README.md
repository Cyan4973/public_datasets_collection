...
The build accepts only uncompressed DICOM transfer syntaxes with `BitsAllocated = 16`, `SamplesPerPixel = 1`, and complete pixel payloads. Compressed DICOM and non-16-bit images are rejected.
