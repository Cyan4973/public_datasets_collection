# ECB FX PLN/EUR Daily

This recipe collects the ECB daily PLN/EUR exchange-rate series and emits one
sample per year.

Selected scope:
- ECB series key: `D.PLN.EUR.SP00.A`
...
```sh
bash datasets/ecb_fx_pln_eur_daily/download.sh
bash datasets/ecb_fx_pln_eur_daily/build.sh
bash datasets/ecb_fx_pln_eur_daily/verify.sh
```
