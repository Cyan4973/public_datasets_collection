...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/nasa_power_daily_temperature_humidity"
FILTERED_ROOT="${DATA_DIR}/filtered/nasa_power_daily_temperature_humidity"
INDEX_ROOT="${DATA_DIR}/index/nasa_power_daily_temperature_humidity"
SAMPLES_ROOT="${DATA_DIR}/samples/nasa_power_daily_temperature_humidity"
LOG_ROOT="${DATA_DIR}/logs/nasa_power_daily_temperature_humidity"
...
dataset_id = "nasa_power_daily_temperature_humidity"
locations = ["san_francisco", "phoenix", "chicago", "miami", "anchorage"]
parameter_ids = ["T2M", "RH2M", "T2MDEW"]
series_defs = [
