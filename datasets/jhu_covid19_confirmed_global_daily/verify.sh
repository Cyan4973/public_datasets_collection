...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/jhu_covid19_confirmed_global_daily"
FILTERED_ROOT="${DATA_DIR}/filtered/jhu_covid19_confirmed_global_daily"
INDEX_ROOT="${DATA_DIR}/index/jhu_covid19_confirmed_global_daily"
SAMPLES_ROOT="${DATA_DIR}/samples/jhu_covid19_confirmed_global_daily"
LOG_ROOT="${DATA_DIR}/logs/jhu_covid19_confirmed_global_daily"
...
dataset_id = "jhu_covid19_confirmed_global_daily"
entities = [
    ("us", "US"),
    ("india", "India"),
    ("brazil", "Brazil"),
...
path = download_root / "time_series_covid19_confirmed_global.csv"
if not path.is_file():
