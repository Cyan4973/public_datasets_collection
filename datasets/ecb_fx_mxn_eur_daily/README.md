# ECB FX MXN/EUR Daily

This recipe collects the ECB daily MXN/EUR exchange-rate series and emits one
sample per year.

Selected scope:
- ECB series key: `D.MXN.EUR.SP00.A`
...
```sh
bash datasets/ecb_fx_mxn_eur_daily/download.sh
bash datasets/ecb_fx_mxn_eur_daily/build.sh
bash datasets/ecb_fx_mxn_eur_daily/verify.sh
```
