...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/nasa_power_daily_solar_temperature_extremes"
FILTERED_ROOT="${DATA_DIR}/filtered/nasa_power_daily_solar_temperature_extremes"
INDEX_ROOT="${DATA_DIR}/index/nasa_power_daily_solar_temperature_extremes"
SAMPLES_ROOT="${DATA_DIR}/samples/nasa_power_daily_solar_temperature_extremes"
LOG_ROOT="${DATA_DIR}/logs/nasa_power_daily_solar_temperature_extremes"
...
parameter_ids = ["ALLSKY_SFC_SW_DWN", "T2M_MAX", "T2M_MIN"]
series_defs = [
...
for (location_id, parameter_id), value_count in sorted(group_counts.items()):
    ...
    for series in series_defs:
        ...
        expected_records[(series["series_id"], sample_slug)] = {
            "dataset_id": "nasa_power_daily_solar_temperature_extremes",
