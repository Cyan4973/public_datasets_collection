...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/owid_land_use_change_co2_annual"
FILTERED_ROOT="${DATA_DIR}/filtered/owid_land_use_change_co2_annual"
INDEX_ROOT="${DATA_DIR}/index/owid_land_use_change_co2_annual"
SAMPLES_ROOT="${DATA_DIR}/samples/owid_land_use_change_co2_annual"
LOG_ROOT="${DATA_DIR}/logs/owid_land_use_change_co2_annual"
...
target_column = "land_use_change_co2"
