# ECB FX JPY/EUR Daily

This recipe collects the ECB daily JPY/EUR exchange-rate series and emits one
sample per year.

Selected scope:
- ECB series key: `D.JPY.EUR.SP00.A`
...
```sh
bash datasets/ecb_fx_jpy_eur_daily/download.sh
bash datasets/ecb_fx_jpy_eur_daily/build.sh
bash datasets/ecb_fx_jpy_eur_daily/verify.sh
```
