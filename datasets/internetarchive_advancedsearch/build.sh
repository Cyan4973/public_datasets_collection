...
(filter_dir/"ingest_stats.json").write_text(json.dumps({"dataset_id":"internetarchive_advancedsearch","rows_total":len(docs),"rows_skipped":skipped},indent=2,sort_keys=True)+"\n",encoding="utf-8")
