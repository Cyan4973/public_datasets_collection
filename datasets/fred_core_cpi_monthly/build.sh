...
DOWNLOAD_ROOT="${DATA_DIR}/downloads/fred_core_cpi_monthly"
FILTERED_ROOT="${DATA_DIR}/filtered/fred_core_cpi_monthly"
INDEX_ROOT="${DATA_DIR}/index/fred_core_cpi_monthly"
SAMPLES_ROOT="${DATA_DIR}/samples/fred_core_cpi_monthly"
LOG_ROOT="${DATA_DIR}/logs/fred_core_cpi_monthly"
...
dataset_id = "fred_core_cpi_monthly"
fred_series_id = "CPILFESL"
value_column = "CPILFESL"
series_defs = [
    {"series_id": "core_cpi_f32", "array_type": "f", "numeric_kind": "float", "bit_width": 32, "endianness": "little", "element_size_bytes": 4},
]
...
path = download_root / "fred_core_cpi_monthly.csv"
if not path.is_file():
