...
PARAMETER_CD="00010"
STAT_CD="00003"
START_DATE="${USGS_NWIS_WATER_TEMPERATURE_START_DATE:-2000-01-01}"
END_DATE="${USGS_NWIS_WATER_TEMPERATURE_END_DATE:-2024-12-31}"
STATES="${USGS_NWIS_WATER_TEMPERATURE_STATES:-az ca co fl ga ia ma md nc nd ny or ri sc tx ut va wa wi wy}"
MIN_VALUES_PER_SAMPLE="${USGS_NWIS_WATER_TEMPERATURE_MIN_VALUES_PER_SAMPLE:-7000}"
MIN_SAMPLE_COUNT="${USGS_NWIS_WATER_TEMPERATURE_MIN_SAMPLE_COUNT:-50}"
REQUEST_DELAY="${USGS_NWIS_WATER_TEMPERATURE_REQUEST_DELAY_SECONDS:-1.0}"
...
def parse_row(row: object) -> tuple[float, str] | None:
    ...
    try:
        ...
        return None
    if not math.isfinite(value) or value <= sentinel:
        return None
